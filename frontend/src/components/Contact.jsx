...
const Contact = () => {
  return (
    <div className=" bg-[#af9a7d]">
      <div className="flex md:flex-row flex-col justify-around p-3">
        {/* Left Side */}
        <div className="flex flex-col justify-center">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Astro Agro <span className='text-white'>Farm Stay</span></h1>
          <p className="text-lg text-white mt-2">“Where Comfort Meets Nature”</p>
        </div>

        {/* Right Side */}
        <div className="flex flex-col justify-center text-right pt-5 md:pt-0">
          <p className="text-2xl font-semibold text-gray-800"> Dilip Khopade</p>
          <p className="text-lg  mt-2 flex items-center gap-3 "><IoCall/>+91-8263841470</p>
          <p className="text-lg  mt-2 flex items-center gap-3 "><IoCall/>+91-8983098891</p>
